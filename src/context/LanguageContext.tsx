...
const en: Translations = {
  ...
  svc_visa_desc: "Fast and reliable visa processing for:\nDubai | Saudi Arabia | China | Turkey | Qatar & more\n\nOur Services\n\n✨ Comprehensive assistance for Tourist, Business, and Transit visas.\n\n✨ Document Preparation: Professional handling of applications and embassy submissions to avoid delays.\n\n✨ Expert Guidance: Clear and accurate information on visa requirements and eligibility.\n\n✨ Fast-Track Processing: Expedited options designed for urgent travel needs.\n\n✨ Real-Time Updates: Stay informed with notifications on your application status at every stage.",
  ...
  svc_umrah_desc: "Spiritual Pilgrimage Services\nWe handle every detail of your journey, so you can focus on your prayers.\n\n🕋 Hassle-Free Visa: Fast and guaranteed Umrah visa processing.\n\n🏨 Hotels near Masjid al-Haram.\n\n🤲 Expert Guidance: Experienced guides to assist with rituals and Ziyarah (holy sites).\n\n🚌 Luxury Transport: Modern, air-conditioned vehicles for all your transfers.\n\n👨‍👩‍👧‍👦 Tailored Plans: Custom packages for families, groups, or solo pilgrims.\n\n🛡️ Licensed, insured, and committed to your safety at every step.",

  about_tag: "About Us",
  about_title: "Why Choose ONTOP Travel Service?",
  about_desc: "🎯 Expert Precision: Every detail of your trip is managed by industry specialists.\n\n👑 Your Comfort, Our Priority: We provide personalized care to ensure a seamless journey.\n\n⚡️ Fast & Reliable: We simplify complex travel plans with speed and efficiency.\n\n🛡️ Total Peace of Mind: Licensed, insured, and committed to your safety at every step.\n\n🌍 Tailored for You: From luxury escapes to business trips, we design it just for you.\n\n\"At ONTOP, we don't just book trips—we craft unforgettable experiences with excellence and care.\"",
  ...
  test_user3_quote: "Ontop helped me get my transit and tourist visa for Dubai within just in 2 hours! Extremely fast, reliable, and professional support.",
...
const am: Translations = {
  ...
  svc_visa_desc: "ፈጣን እና አስተማማኝ የቪዛ አሰራር ለ፡\nዱባይ | ሳዑዲ አረቢያ | ቻይና | ቱርክ | ኳታር እና ሌሎችም\n\nአገልግሎቶቻችን\n\n✨ ለቱሪስት፣ ለንግድ እና ለትራንዚት ቪዛዎች ሁሉን አቀፍ ድጋፍ።\n\n✨ የሰነድ ዝግጅት፡ መዘግየቶችን ለማስወገድ የማመልከቻዎች እና የኤምባሲ ማቅረቢያዎች ሙያዊ አያያዝ።\n\n✨ የባለሙያ መመሪያ፡ በቪዛ መስፈርቶች እና ብቁነት ላይ ግልጽ እና ትክክለኛ መረጃ።\n\n✨ ፈጣን ሂደት፡ ለአስቸኳይ የጉዞ ፍላጎቶች የተነደፉ ፈጣን አማራጮች።\n\n✨ ፈጣን መረጃዎች፡ በማመልከቻዎ ሁኔታ ላይ በየደረጃው ከሚሰጡ ማሳወቂያዎች ጋር መረጃ ያግኙ።",
  ...
  about_desc: "🎯 የባለሙያ ትክክለኛነት፡ የጉዞዎ እያንዳንዱ ዝርዝር በኢንዱስትሪ ባለሙያዎች ነው የሚተዳደረው።\n\n👑 ምቾትዎ፣ ቅድሚያ የምንሰጠው፡ እንከን የለሽ ጉዞን ለማረጋገጥ ግላዊ እንክብካቤን እንሰጣለን።\n\n⚡️ ፈጣን እና አስተማማኝ፡ ውስብስብ የጉዞ እቅዶችን በፍጥነት እና በብቃት እናቃልላለን።\n\n🛡️ ፍጹም የአእምሮ ሰላም፡ ፈቃድ ያለው፣ ዋስትና ያለው፣ እና በየደረጃው ለደህንነትዎ የተቆረጠ።\n\n🌍 ለእርስዎ የተበጀ፡ ከቅንጦት ጉዞዎች እስከ የንግድ ጉዞዎች፣ ለእርስዎ ብቻ እናዘጋጃለን።\n\n\"በ ONTOP፣ ጉዞዎችን ቦታ ማስያዝ ብቻ ሳይሆን — የማይረሱ ተሞክሮዎችን በጥራት እና በእንክብካቤ እንቀርጻለን።\"",
  ...
  test_user3_quote: "Ontop በ2 ሰዓት ውስጥ ለዱባይ የሚሆን የትራንዚት እና የቱሪስት ቪዛ እንድያገኝ ረድቶኛል! በጣም ፈጣን፣ አስተማማኝ እና ሙያዊ ድጋፍ።",

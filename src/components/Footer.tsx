        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="https://t.me/ONTOPTR" target="_blank" rel="noopener noreferrer" className="flex items-start gap-2 text-background/60 text-sm hover:text-background transition-colors">
                  <Send className="w-4 h-4 mt-0.5 shrink-0 text-primary" />
                  <span>{t.contact_telegram_join}</span>
                </a>
              </li>
              <li>
                <a href="https://maps.app.goo.gl/Bgkv4tzRdLcvc7wx5?g_st=ic" target="_blank" rel="noopener noreferrer" className="flex items-start gap-2 text-background/60 text-sm hover:text-background transition-colors">
                  <MapPin className="w-4 h-4 mt-0.5 shrink-0" />
                  <span>Addibs Ababa, Merkato ,Haji Legese Business Center , first floor </span>
                </a>
              </li>
            </ul>
          </div>
